...
Gem::Specification.new do |s|
  ...
  s.executables = ["blux"]
  s.extra_rdoc_files = ["COPYING", "README.markdown", "bin/blux", "lib/blog_manager.rb", "lib/blux_config_reader.rb", "lib/blux_option_parser.rb", "lib/draft_manager.rb", "lib/indexer.rb", "lib/textile_to_html.rb", "lib/wp_publish.rb"]
  s.files = ["Blux.gemspec", "COPYING", "Manifest", "README.markdown", "Rakefile", "bin/blux", "lib/blog_manager.rb", "lib/blux_config_reader.rb", "lib/blux_option_parser.rb", "lib/draft_manager.rb", "lib/indexer.rb", "lib/textile_to_html.rb", "lib/wp_publish.rb", "spec/blog_manager_spec.rb", "spec/blux_config_reader_spec.rb", "spec/draft_manager_spec.rb"]
